...
| Lokal/central administratör | SKA ha en registrerad[TKAdministratorRole](StructureDefinition-tk-administrator-role.md)med rätt administrationsnivå (REQ-ADM-1); lokal administratör SKA representera den organisation vars poster ändras (REQ-ADM-2). SKA registrera via transaction-Bundle med tillhörande Provenance-post (REQ-TRC-1/2). |
