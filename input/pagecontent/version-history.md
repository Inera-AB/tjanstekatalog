...
- Aktören Organization Endpoint Writer, med operationerna
  `$add-organization-to-endpoint` och `$remove-organization-from-endpoint`
- Två CapabilityStatements: tjänstekatalogens administrativa API (server)
  och Organization Endpoint Writer Capabilities (klient)
